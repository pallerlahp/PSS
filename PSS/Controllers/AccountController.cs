...
namespace PSS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //return RedirectToAction("Create","Admin/PSS_User_Type");
        ...
        public ActionResult LogOut()
        {
            ...
            {
                var c = new HttpCookie("_RequestVerificationToken");
                c.Expires = DateTime.Now.AddDays(-1);
                Response.Cookies.Add(c);
            }
            if (Request.Cookies[".AspNet.ExternalCookie"] != null)
            {
                var c = new HttpCookie(".AspNet.ExternalCookie");
                c.Expires = DateTime.Now.AddDays(-1);
                Response.Cookies.Add(c);
            }
            ...
            //if (c != null)
            //{
            //    c = new HttpCookie("_RequestVerificationToken");
            //    c["AT"] = null;
            //    c.Expires = DateTime.Now.AddDays(-1);
            ...
            AuthenticationManager.SignOut(Microsoft.AspNet.Identity.DefaultAuthenticationTypes.TwoFactorRememberBrowserCookie);
            Session.RemoveAll();
            Session.Abandon();
